...
import { Home, Briefcase, Wallet, FileText, Target, MessageCircle, Settings, Users } from 'lucide-react';
      ...
      <div className="p-4 border-b">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="font-medium text-gray-900">João Paulo</span>
            <span className="text-xs text-gray-500">Cliente desde 2023</span>
          </div>
        </div>
      </div>
